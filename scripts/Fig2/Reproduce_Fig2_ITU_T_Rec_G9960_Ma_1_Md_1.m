...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %%
addpath('../../data/Fig2')
load('Fig2_Parameters_for_ITU_T_Rec_G9960_Ma_1_Md_1.mat');
...
% Fig 2 (ITU-T Rec. G9960 Ma=Md=1)
figure,
plot(x(indices),y_h(indices), 'DisplayName', 'h_k^{t-e}(M_a=M_d=1)', 'Color', "#EDB120"); hold on; grid on;
