...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %%
addpath('../../data/Fig2')
load('Fig2_Parameters_for_ITU_T_Rec_G9960_Ma_0_Md_0.mat');
...
% Fig 2 (ITU-T Rec. G9960 Ma=Md=0)
figure,
plot(x(indices),y_h(indices), 'DisplayName', 'h_k^{t-e}(M_a=M_d=0)', 'Color', "#4DBEEE"); hold on; grid on;
